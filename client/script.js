...
function firstpage(){
    return (
        ...
        <div class="text-purple-800 w-full md:max-w-2xl lg:max-w-3xl md:h-full md:flex md:flex-col px-6 dark:text-purple-100">
           ...
           <center><img src = "https://github.com/yiting5167/ChatBot/blob/main/client/chatbot_front.GIF?raw=true"  width="250"  /></center>
        </div>
        `
    )
}
...
const handleSubmit = async (e) => {
    ...
    const response = await fetch('https://chatbot-bdoq.onrender.com', {
        method: 'POST',
        headers: {
